...
//			float B5 = 0.4045;
//
//			uk = (A1*ek + A2*ek_1 + A3*ek_2 + A4*ek_3 + A5*ek_4 - B2*uk_1 - B3*uk_2 - B4*uk_3 - B5*uk_4)/B1;

//			D_10ms =
//
//			   1.138 z^13 - 1.705 z^-1 - 0.479 z^-2 + 1.607 z^-3 - 0.5603 z^-4
//			  -----------------------------------------------------------------
//			  0.6807 z^13 - 0.1136 z^12 - 1.075 z^11 + 0.1032 z^10 + 0.4045 z^9
//
